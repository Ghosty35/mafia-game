...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-zinc-950 border-r border-zinc-800/80 h-[calc(100vh-56px)] overflow-y-auto sticky top-14 hidden md:block" aria-label="Sidebar navigation">
      <div className="p-4">
