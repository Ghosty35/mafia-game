-- 147_economy_config_power_packs.sql
-- Add power_packs to get_economy_config() so the Arsenal page no longer
-- hardcodes pack prices. The server is still the enforcer via buy_power.
