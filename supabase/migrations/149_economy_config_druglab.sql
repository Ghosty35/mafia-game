-- 149_economy_config_druglab.sql
-- Add druglab economy config to get_economy_config() so the client
-- no longer hardcodes drug-lab costs, guard prices, and bribe formula.
